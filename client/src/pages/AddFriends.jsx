...
const AddFriends = () => {
  ...
  return (
    <div className="add-friends-page">
      ...
      <div className="users-list bg-gray-800 p-6 rounded-lg shadow-lg">
        {users.length > 0 ? (
          users.map((user) => (
            <div
              key={user._id}
              className="user-card p-4 mb-2 bg-gray-700 rounded-lg flex justify-between items-center"
            >
...
// Helper function to handle adding a friend
